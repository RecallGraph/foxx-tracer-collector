...
const { reporters: { ConsoleReporter } } = require('@recallgraph/foxx-tracer-reporter-console')
const { reporters: { DatadogReporter } } = require('@recallgraph/foxx-tracer-reporter-datadog')
...
const reporters = Object.freeze({
  ...
  datadog: () => {
    ...
    return new DatadogReporter(ddURL)
  }
})
